...
var test_file_json = {
  name: 'Florida Food Inspection tests by name',
...
var testCaseStream = through.obj(function(record, encoding, callback) {
  var full_name = record.dba + ', ' + record.location_city + ', FL, ' + record.location_zip_code;
...
importTestCases('florida_food_inspections_by_name', test_file_json, full_stream, 5000, 1);
